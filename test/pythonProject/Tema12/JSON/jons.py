...
def employees_rewrite(sort_type):
    with open('C:/Users/user/PycharmProjects/proba345/pythonProject/Tema12/JSON/employees.json', 'r') as f:
        data = json.load(f)
    ...
    with open(f'C:/Users/user/PycharmProjects/proba345/pythonProject/Tema12/JSON/employees_{sort_type}_sorted.json', 'w') as f:
